...
def usage(args):
  ...
  mdl.simulate(tf=args.time, 
               position=np.array([1., 1., 0.])) #initial position
...
if __name__ == "__main__":
  ...
  parser.add_argument("--model", "-m", type=str, default="mujoco", choices=["base", "mujoco"], help="Model to use.")
